...
import { MaquinariaFactory } from '../patterns/factory/MaquinariaFactory.js';
import { GPSAdapter } from '../patterns/adapter/GPSAdapter.js';
...
class MaquinariaService {
  ...
  findById(id) {
    ...
    maquinaria.coordenadasGps = gps.getExactLocation(maquinaria.id);
